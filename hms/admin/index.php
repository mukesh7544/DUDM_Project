	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<h2 style="text-align:center"><b>SUPER ADMIN LOGIN</b></h2>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						...
						<legend>
							...
							<div id="captcha" style="height: 20px; width: 50px; border: 1px solid black; text-align:center;"></div>
							<br>
    	  	   				  <input type="text" id="captchaInput" placeholder="Enter CAPTCHA">
 							   <button onclick="validateCaptcha()"></button>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> DUDMS</span>. <span>Created by TechTitans</span>
					</div>
        ...
        function displayCaptcha() {
            var captchaText = generateCaptcha(); // Generate 4-digit CAPTCHA
