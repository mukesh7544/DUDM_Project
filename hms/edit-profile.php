...
$sql=mysqli_query($con,"Update users set fullName='$fname',Enro='$Enro',branch='$branch',sem='$sem',address='$address',city='$city',gender='$gender' where id='".$_SESSION['id']."'");
if($sql)
{
...
<html lang="en">
	<head>
		<title>Students | Edit Profile</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Students | Edit Profile</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Students </span>
...
<hr />													<form role="form" name="edit" method="post">
	...
	<input type="text" name="Enro" class="form-control" value="<?php echo htmlentities($data['Enro']);?>" >
														</div>
														<div class="form-group">
															<label for="branch">
																 Branch:
															</label>
	<input type="text" name="branch" class="form-control" value="<?php echo htmlentities($data['branch']);?>" >
														</div>
	...
	<input type="text" name="sem" class="form-control" value="<?php echo htmlentities($data['sem']);?>" >
														</div>
